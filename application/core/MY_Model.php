...
class MY_Model extends CI_Model
{
	...
	public function getGroupby(){
		...
		$this->db->select('vote_history.id_finalis , SUM(vote_history.jumlah) as total');
		$this->db->group_by('vote_history.id_finalis'); 
		$this->db->order_by('SUM(vote_history.jumlah)', 'desc'); 
		return $this->db->get('vote_history')->result();
